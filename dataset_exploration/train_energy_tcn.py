#!/usr/bin/env python3
"""Train and evaluate a shared TCN model for house-level energy targets."""
...
from dataset_exploration.storenet_ml.models import SharedEnergyTCN
...
def main() -> None:
    """Train and evaluate the shared TCN energy model."""
    ...
    for epoch in epoch_progress:
        ...
        if val_loss < best_val_loss:
            ...
            best_checkpoint = save_checkpoint(
                ...
                stats.target_mean,
                stats.target_std,
                checkpoint_name="shared_energy_tcn.pt",
            )
        else:
            patience_left -= 1
            if patience_left <= 0:
    ...
    metrics_path = ARTIFACT_DIR / "shared_energy_tcn_metrics.json"
